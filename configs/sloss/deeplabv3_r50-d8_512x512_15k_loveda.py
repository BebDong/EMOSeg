...
param_scheduler = [dict(type='PolyLR', eta_min=1e-4, power=0.9, begin=0, end=15000, by_epoch=False)]
train_cfg = dict(type='IterBasedTrainLoop', max_iters=15000, val_interval=1500)
