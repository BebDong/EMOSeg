...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=True,
        loss_decode=dict(
            # type='SensitiveLoss', num_classes=num_classes, gamma=0.5, use_scale=False, loss_weight=1.0),
            # type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0,
            # class_weight=[0.8316, 0.9079, 0.8506, 1.0241, 1.0072, 0.9885, 1.0963, 1.0343, 0.8655, 0.9917,
            #               0.9276, 0.989, 1.1265, 0.9015, 1.0797, 1.0882, 1.0888, 1.1492, 1.0519]
