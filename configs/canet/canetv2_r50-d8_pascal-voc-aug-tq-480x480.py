...
data_root = 'data/VOCdevkit/VOCAug'
train_pipeline = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        data_prefix=dict(img_path='img_aug', seg_map_path='cls_aug'),
        ann_file='train_aug.txt',
...
param_scheduler = [dict(type='PolyLR', eta_min=0., power=0.9, begin=0, end=80000, by_epoch=False)]
