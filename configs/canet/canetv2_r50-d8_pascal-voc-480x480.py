...
model = dict(
    ...
    decode_head=dict(
        ...
        # loss_decode=dict(type='SensitiveLoss', num_classes=num_classes, gamma=0.4, use_scale=True, loss_weight=1.0)),
    train_cfg=dict(),
...
# optimizer
optimizer = dict(type='SGD', lr=1e-3, momentum=0.9, weight_decay=1e-5)
